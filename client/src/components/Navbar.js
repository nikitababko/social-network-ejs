...
function trigger(image, name) {
    return (
        <span>
            <Image size="mini" avatar src={"/images/profile-picture/100x100/" + image} />{" "}
            {name}
        </span>
    );
}
...
class Navbar extends Component {
    ...
    handleNotificationPopupToggle = (e) => {
        ...
        if (!notifications.length) {
            dispatch(notificationActions.fetchNotifications({ initialFetch: true }, ids));
        } else {
                            ...
                            <Menu.Menu className="nav-container">
                                ...
                                <Menu.Menu position="right">
                                    ...
                                    <NotificationPopup>
                                        <Menu.Item
                                            onClick={(e) =>
                                                this.handleNotificationPopupToggle(e)
                                            }
                                        >
