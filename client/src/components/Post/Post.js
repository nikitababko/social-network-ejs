...
import { Icon, Button, Dropdown, Modal, Segment, Image } from "semantic-ui-react";
...
class Post extends Component {
    ...
    getPostComments = () => {
        ...
        if (
            ...
            dispatch(commentActions.getPostComments(post._id, { initialFetch: true }));
        }
    };
    ...
    render() {
        ...
        const { open, optionsLoggedIn, optionsNotLoggedIn, value, showTags } = this.state;
                        ...
                        {post.author[0]._id === _id ? (
                            <Button.Group>
                                <Dropdown
                                    ...
                                    trigger={<div class="fa-ellipsis-h"></div>}
                                />
                            </Button.Group>
                        ) : (
                            <Button.Group>
