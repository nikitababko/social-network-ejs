...
http.listen(3000, function () {
    ...
    mongoClient.connect("mongodb://localhost:27017", function (error, client) {
                    ...
                    if (user == null) {
                        ...
                        if (
                            ...
                            if (user.profileImage != "") {
                                fileSystem.unlink(user.profileImage, function (
                                    error
                                ) {
                                    //
                                });
                            ...
                            database.collection("pages").findOne(
                                ...
                                function (error, page) {
                                    if (page == null) {
                                        ...
                                        if (
                                            page.user._id.toString() !==
                                            user._id.toString()
                                        ) {
                                            result.json({
                                                status: "error",
                                                message:
                                                    "Sorry, you do not own this page",
                                            });
                                            return;
                                        }
        ...
        app.get("/verifyEmail/:email/:verification_token", function (
            request,
            result
        ) {
            //
