...
const MessengerMessages = ({ message, userId, profilePicture, currentRoom }) => {
                    ...
                    <Popup
                        ...
                        trigger={
                            <p>
                                ...
                                <span className="message-data message-data--replies">
                    ...
                    <Popup
                        ...
                        trigger={
                            <p>
                                {" "}
                                <Linkify options={linkifyOptions}>{message.text}</Linkify>
                                <span className="message-data message-data--sent">
                                    {dayjs(message.createdAt).format("hh:mm a")}
                                </span>
                            </p>
                        }
